...
def main():
    pg.init()
    pg.display.set_caption("Ballistic")
    font = pg.font.Font("Assets/Fonts/SciFiBronze-Regular.ttf", 48)
    
    sounds = load_sounds()
    m_vol, sfx_vol, music = 0.05, 0.1, 0
...
def load_sounds():
    ...
    sounds['music0'] = pg.mixer.Sound('Assets/Sounds/cosmos-space-game-action-shooter-astronauts-scifi-aliens-142978.mp3')
    sounds['music1'] = pg.mixer.Sound('Assets/Sounds/night-racing-video-game-soundtrack-outrun-retro-80s-156044.mp3')
